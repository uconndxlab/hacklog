...
@section('title', 'Edit Resource - ' . $project->name)
...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('projects.resources.update', [$project, $resource]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3" id="content-field" style="display: none;">
                        ...
                        <input id="content" type="hidden" name="content" value="{{ old('content', $resource->content) }}">
