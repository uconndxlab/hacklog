                ...
                <form action="{{ route('projects.update', $project) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select 
                            ...
                            name="staffing_model" 
                            required>
                            <option value="dedicated" {{ old('staffing_model', $project->staffing_model) === 'dedicated' ? 'selected' : '' }}>Dedicated Team</option>
                            <option value="shared" {{ old('staffing_model', $project->staffing_model) === 'shared' ? 'selected' : '' }}>Shared</option>
                        </select>
                        <div class="form-text">
