    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="card-body py-2">
                <form method="GET" action="{{ route('timeline.index') }}" class="d-flex align-items-center gap-3 flex-wrap">
                    ...
                    @if($showCompleted)
                        <a href="{{ route('timeline.index', array_filter(['start' => $filterStart, 'end' => $filterEnd])) }}" class="btn btn-sm btn-outline-secondary">Hide Completed</a>
                    @else
                        <a href="{{ route('timeline.index', array_filter(['start' => $filterStart, 'end' => $filterEnd, 'show_completed' => '1'])) }}" class="btn btn-sm btn-outline-secondary">Show Completed</a>
                    @endif
