...
@section('title', auth()->user()->isAdmin() ? 'Edit User - ' . $user->name : 'Edit Profile')
    ...
    <div class="col-lg-8">
        <div class="mb-4">
            ...
            @else
                ...
                <p class="text-muted mb-0">Update your name, email, nicknames, and Slack ID</p>
            @endcan
        </div>
                ...
                <form action="{{ route('users.update', $user) }}" method="POST">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            {{ auth()->user()->isAdmin() ? 'Update User' : 'Update Profile' }}
                        </button>
                        @can('admin')
